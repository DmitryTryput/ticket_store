...
CREATE TABLE films (id INT AUTO_INCREMENT, title VARCHAR(40)  UNIQUE NOT NULL, create_date DATE, 
country_id INT, PRIMARY KEY(id),
FOREIGN KEY (country_id) REFERENCES countries(id));
...
CREATE TABLE users (id INT AUTO_INCREMENT, email VARCHAR(40) UNIQUE NOT NULL, first_name VARCHAR(40) NOT NULL, 
						last_name VARCHAR(40), middle_name VARCHAR(40),
                        user_value DECIMAL, PRIMARY KEY(id));
